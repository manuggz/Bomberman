...
para cambiar a pantalla completa presionen ALT + ENTER para salirJuego cambien a window o ALT + F4
para coger un player en el editor de niveles click derecho del mouse ;)
